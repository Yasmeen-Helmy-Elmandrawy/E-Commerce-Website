...
function renderProducts() {
    productsContainer.innerHTML = `
        <div class=" col-12 text-center mb-5">
            <h2 style="width:fit-content; margin:auto;" class="title text-black fw-bold py-2 position-relative">Shopping Cart</h2>
        </div>
        <hr>`
        ...
        productsContainer.innerHTML += `
            <div class="row align-items-center gy-4 text-center text-md-start">
                <div class="col-md-5 box">
                    <img src="${products[i].image}" loading="lazy" class=" w-100 img-fluid  bg-secondary bg-opacity-10 rounded-top" alt="Realme C53">
                </div>        
